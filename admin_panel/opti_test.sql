...
CREATE TABLE IF NOT EXISTS opti (
    id_employee INT PRIMARY KEY,  -- remove AUTO_INCREMENT if IDs are manually assigned
...
CREATE TABLE IF NOT EXISTS opti_rec (
    ...
    late_minutes INT DEFAULT 0,          -- matches backend
    undertime_minutes INT DEFAULT 0,     -- matches backend
